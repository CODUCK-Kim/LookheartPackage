...
public class ToastHelper {
    ...
    public func showToast(in chartView: UIView, _ message: String, withDuration: Double, delay: Double) {
        ...
        let containerHeight: CGFloat = 35
        let containerX: CGFloat = (chartView.frame.width - containerWidth) / 2
        let containerY: CGFloat = (chartView.frame.height - containerHeight) / 2
        
        toastContainer.frame = CGRect(x: containerX, y: containerY, width: containerWidth, height: containerHeight)
        ...
        chartView.addSubview(toastContainer)
